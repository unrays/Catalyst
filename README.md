...
This project is primarily an experiment with several concepts, such as polymorphic factories and smart pointers! It's not perfect, but as I mentioned in my Lumen repository, I didn't recode this mini smart pointer system for performance and production; it's mainly for learning purposes. During this work, I was able to improve and consolidate my knowledge and skills related to pointers and templates, including pack expansions and variadic templates, which are, let's be honest, insane.
